package com.groupandmenu.mypicker.datepicker;
...
import com.groupandmenu.mypicker.datepicker.util.LinearGradient;
...
public class WheelPicker<T> extends View {
	...
	private void initAttrs(Context context, @Nullable AttributeSet attrs) {
		...
		mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_selectedTextColor, Color.parseColor("#1E88F5"));
...
//					mTextPaint.setColor(Color.parseColor("#A6A6A6"));
//
//				} else {
                    mSelectedItemPaint.setColor(mSelectedItemTextColor);
//                    mTextPaint.setColor(mTextColor);
