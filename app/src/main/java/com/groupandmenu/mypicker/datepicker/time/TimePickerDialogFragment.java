package com.groupandmenu.mypicker.datepicker.time;
...
import com.groupandmenu.mypicker.datepicker.date.DatePicker;

public class TimePickerDialogFragment extends DialogFragment {
    protected DatePicker mDatePicker;
    HourAndMinutePicker hPicker;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        hPicker= view.findViewById(R.id.hourPicker_dialog);
            ...
            public void onClick(View v) {
                if (mOnDateChooseListener != null) {
                    mOnDateChooseListener.onDateChoose(mDatePicker.getYear(),
                            mDatePicker.getMonth(), mDatePicker.getDay(),hPicker.getHour(),hPicker.getMinute());
                }
                dismiss();
            }
        });
    ...
    public interface OnDateChooseListener {
        void onDateChoose(int year, int month, int day, int hour, int minute);
    }
}
